"""
M7 triangular — CLI orchestration for triangular cycle enumeration.

Contains main(), helpers for graph construction from cache/runtime,
per-leg quoting, size sweeps, and measured scoring pipeline.
...
from m7.triangular.graph import (
...
from m7.triangular.repeatability import (
    build_blocker_repeatability,
    build_regime_repeatability_summary,
)
from m7.triangular.verdicts import build_verdict_summary

logger = logging.getLogger("m7.triangular.cli")
