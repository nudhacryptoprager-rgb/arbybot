...
# E1.64: profit gate reject reasons
REJECT_USD_BASIS_MISSING = "USD_BASIS_MISSING"
REJECT_MIN_PROFIT_USD_NOT_MET = "MIN_PROFIT_USD_NOT_MET"
REJECT_DEPTH_MATH_INVALID = "DEPTH_MATH_INVALID"
...
# Base production: E1.27/C3 expanded 7→11, then E1.48 promoted meme productives.
...
PREWARM_PAIRS_BASE = [
    ...
    ("BRETT", "WETH"), ("DEGEN", "WETH"), ("TOSHI", "WETH"),  # E1.48 productive memes (cross_dex >= 2)
]
