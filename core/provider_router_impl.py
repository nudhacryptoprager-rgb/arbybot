"""Multi-provider RPC router with automatic failover.

Canonical home is the ``core`` layer (dependency direction: milestone
packages import core, never the reverse).  ``m9.graph_arb.provider_router``
remains as a thin re-export shim for backward compatibility.
