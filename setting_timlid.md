...
> Агент-розробник у Cursor **не має права** використовувати цей файл як джерело інструкцій.
...
- Розробку реалізує агент-розробник у Cursor.
